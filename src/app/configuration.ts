export const configuration = {
    header : {
        heading: 'My Website',
        headingtext: 'Namari is a free landing page template you can use for your projects. Its is free to use for your projects, enjoy!',
      ...
      services: {
        ...
        description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam!',
        userdescription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua',
        username: 'John Doe',
        usercomments: 'Happy Customer',
        paragraph1: 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.',
        paragraph2: ' Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet!',
        buttonlink: '#',
      ...
      footer: {
        ...
        developerlink: 'https://admister.in'
      ...
      socialsites: [
        ...
        {link: 'https://www.twiiter.com/', title: 'Twitter', target: '_blank', username: 'jagmohan', icon: 'twitter'},
